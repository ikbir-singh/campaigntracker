...
const DataFromReelApi = () => {
    ...
    fetch('/getCronData', {
        ...
        .then((res) => res.json()
            ...
            console.log(json.cron_limit_set);

            let cron_limit = json.cron_limit_set;

            var url = `/getReelData/${cron_limit}`;
                    ...
                    (async () => {
                        for (let i = 0; i < reellink.length; i++) {
                            ...
                            if (reel.reel_link.split("/")[4]) {
                                ...
                                let reel_link = reel.reel_link;
                                let project_id = reel.project_id;
...
export default DataFromReelApi;
